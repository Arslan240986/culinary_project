...
app_name = 'contact'
urlpatterns = [
    path('', views.contact_view, name='contact_subscribe'),
    path('edit/', views.edit, name='user_profile'),
    # path('personal/<int:pk>', views.personal_page, name='personal_page'),
    # path('personal/draft/<int:pk>', views.personal_draft_page, name='personal_draft_page'),
    # path('personal/dish/book/<int:pk>', views.user_dish_book, name='user_dish_book'),
